...
export const countries: Country[] = [
  ...
  {
    name: 'Bangladesh', iso: '050', lat: 24, lng: 90,
    official: 173, ospi: 181, conf: 'med',
    urbanPct: 40, growthRate: 1.0, densityKm2: 1329, gdpPerCapita: 2824, region: 'South Asia',
    signals: { telecom: 76, electricity: 63, building: 66, mobility: 61, internet: 52 },
    history: [2018,2019,2020,2021,2022,2023].map((y,i) => ({ y, v: 161 + i * 2 })),
    regions: [
      { name: 'Dhaka', pop: 24, ospi: 27, conf: 'med' },
      { name: 'Chittagong', pop: 33, ospi: 34, conf: 'med' },
      { name: 'Khulna', pop: 16, ospi: 16, conf: 'med' },
      { name: 'Rajshahi', pop: 20, ospi: 21, conf: 'low' },
    ],
  },
  {
    name: 'United Kingdom', iso: '826', lat: 55, lng: -3,
    official: 68, ospi: 67, conf: 'high',
    urbanPct: 84, growthRate: 0.3, densityKm2: 281, gdpPerCapita: 46510, region: 'Western Europe',
    signals: { telecom: 96, electricity: 95, building: 91, mobility: 90, internet: 96 },
    history: [2018,2019,2020,2021,2022,2023].map((y) => ({ y, v: 67 })),
    regions: [
      { name: 'England', pop: 57, ospi: 56, conf: 'high' },
      { name: 'Scotland', pop: 5.5, ospi: 5.4, conf: 'high' },
      { name: 'Wales', pop: 3.2, ospi: 3.1, conf: 'high' },
      { name: 'Northern Ireland', pop: 1.9, ospi: 1.9, conf: 'high' },
    ],
  },
  {
    name: 'Italy', iso: '380', lat: 42, lng: 12,
    official: 59, ospi: 58, conf: 'high',
    urbanPct: 71, growthRate: -0.2, densityKm2: 201, gdpPerCapita: 38493, region: 'Southern Europe',
    signals: { telecom: 94, electricity: 92, building: 88, mobility: 87, internet: 91 },
    history: [2018,2019,2020,2021,2022,2023].map((y,i) => ({ y, v: 60 - i * 0.2 })),
    regions: [
      { name: 'Lombardy', pop: 10, ospi: 10, conf: 'high' },
      { name: 'Lazio', pop: 5.8, ospi: 5.7, conf: 'high' },
      { name: 'Campania', pop: 5.6, ospi: 5.5, conf: 'med' },
      { name: 'Sicily', pop: 4.8, ospi: 4.7, conf: 'med' },
    ],
  },
